...
### loop through leaf_size ###
    ...
    plt.ylabel("RMSE")
    plt.title("Compare DT and RT")
    plt.plot(leaf_array, rmse_inRT, label="RT: In-sample Data")
    plt.plot(leaf_array, rmse_outRT, label="RT: out-of-sample Data")
